...
namespace SadOrder;
    ...
    public class OrderTests
    {
        ...
        public void NewOrder_GetStatus_Returns_Draft()
        {
            ...
            // Assert
            Assert.Equal(result, OrderStatus.DRAFT);
        }
        ...
        public void DraftOrder_AddProduct_IncreasesGetProductsCountAndContainsProduct()
        {
            ...
            Assert.Contains(_sut.GetProducts(), x => x.ProductId == _productId);
        }
        ...
        public void TestTotalPrice()
        {
            ...
            Assert.Equal(100, _sut.GetTotalPrice().Value);
        }
        ...
        public void TestTotalPrice_IncludeTax()
        {
            ...
            Assert.Equal(298, _sut.GetTotalPrice().Value);
        }
        ...
        public void TestTotalPrice_DoesntChangeProductPrice()
        {
            ...
            Assert.Equal(100, result.GetPrice().Value);
            Assert.Equal(_sut.GetTotalPrice().Value, 198);
        }
        ...
        public void TestTotalPrice_SubmittedStatus()
        {
            ...
            Assert.Equal(OrderStatus.SUBMITTED, _sut.GetStatus());
            Assert.Equal(398, _sut.GetTotalPrice().Value);
        }
